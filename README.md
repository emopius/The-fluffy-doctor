...
Откроется это окно. Здесь нужно корректно заполнить все данные и по окончанию нажать на кнопку "Провести и закрыть" <br /> <br />

<img src="https://stroicraft.ru/wp-content/uploads/github2/6.jpg" alt="Шаг 3"/>
После успешного проведения документа автоматически создается талон со всей информацией <br /> <br />
